...
Returns a value in a serie

**Parameters**

- **id** - **String** - *required*: ID of the serie
- **end** - **String** - *optional*: Date in standard format before which we consider observations

**Response**

- **value** - **Float**: Last value in serie, before ***end*** if specified

### getObsDate

Returns a date in a serie
...
- **value** - **Float**: Last date in serie, before ***end*** if specified

### getObsSum

Returns the sum over values in a serie

**Parameters**

- **id** - **String** - *required*: ID of the serie
- **end** - **String** - *optional*: Date in standard format before which we consider observations
- **periods** - **Integer** - *optional*: Number of values considered before the last 

**Response**

- **value** - **Float**: Sum over last ***periods+1*** values in serie, before ***end*** if specified

### getObsAverage

Returns the average over values in a serie
...
- **value** - **Float**: Average over last ***periods+1*** values in serie, before ***end*** if specified

### getObsChange

Returns the absolute difference between two values in a serie

**Parameters**

- **id** - **String** - *required*: ID of the serie
- **end** - **String** - *optional*: Date in standard format before which we consider observations
- **periods** - **Integer** - *optional*: Number of observations seperating the first from the last, counting the first

**Response**

- **value** - **Float**: Absolute (chronological) difference between the last and the ***periods***-th last values

### getObsChangePercent

Returns the relative difference between two values in a serie
...
- **value** - **Float**: Relative (chronological) difference between the last and the ***periods***-th last values

### getPoint

Returns a point in a serie
...
- **value** - **Array**: Last date-value pair, before ***end*** if specified

### getPointSum

Returns the sum over values in a serie as a point
...
- **value** - **Array**: Date-value pair, with the value being the sum over last ***periods+1*** values in serie and the date the last, before ***end*** if specified
